            ...
            if (isValid)
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        String query = "INSERT INTO bookings VALUES (@userCNP, @roomId, @startDate, @endDate)";

                        command.CommandText = query;
                        command.Parameters.AddWithValue("@userCNP", user.Cnp.ToString());
                        command.Parameters.AddWithValue("@roomId", room.Id.ToString());
